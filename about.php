...
<!-- Mirrored from html.aqlova.com/landor-prev/landor/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Jun 2026 07:22:12 GMT -->
<head>
    <meta charset="UTF-8">
...
<body class="tp-magic-cursor">
    ...
    <!-- about-area,start  -->
     <section class="tp-about-area tp-about-spacing-3 p-relative fix">
        <div class="tp-about-shape-home p-absolute d-none d-md-block">
            <img src="assets/img/about/about-shape-home.html" alt="">
        </div>
        <div class="container">
            <div class="tp-about-heading pb-70 tp-text-center reval-line">
                <h2 class="tp-section-title margin-0">Leading privately owned real estate investors <br>
                ...
                <!-- <div class="tp-testi-card">
                    <div class="tp-testi-card-left">
                        <div class="tp-testi-card-awards">
                            ...
                            <img src="assets/img/testimonail/testimonail-award-2.png" alt="">
                            <img src="assets/img/testimonail/testimonail-award-3.png" alt="">
                        </div>
                        <div class="tp-testi-card-content">
                            <p class="fw-500 tp-text-black margin-0">“ Their expert strategies helped us scale <br>
                            faster than we imagined. Our revenue <br>
                            grew by 50% in just six months. ”</p>
                            <div class="tp-testi-card-review pt-30">
                                <img src="assets/img/testimonail/testimonail-review.png" alt="">
                                <span class="d-inline-block fw-500 tp-text-black">Construction Manager</span>
                            </div>
                        </div>
                    </div>
                    <div class="tp-testi-card-right">
                        <h3 class="tp-testi-card-title">Keep communication <br>
                            transparent</h3>
                        <div class="tp-testi-fact">
                            <h4 class="tp-testi-fact-num"><span class="odometer" data-count="99"></span>%</h4>
        ...
        <div class="container">
            <div class="tp-floting-card-main p-relative">
                <div class="tp-floting-card-content reval-line">
                    <h2 class="tp-floting-card-title mb-45">Heritage</h2>
                    <p class="tp-text-black fw-500 margin-0">Each Ardène residence is more than a <br>
                    home. It is a dialogue between landscape, <br>
                    architecture, and light — designed to <br>
                    belong, to endure, to inspire</p>
                </div>
                <div class="tp-floting-card-img">
                    <div class="tp-floting-card-img-item-1 br-10 d-none d-lg-block p-absolute">
                        <img src="assets/img/floting/floting-img-1.jpg" alt="">
                        <h3 class="tp-floting-card-img-placeholder pt-10">Modern</h3>
                    </div>
                    <div class="tp-floting-card-img-item-2 br-10 p-absolute">
                        <img src="assets/img/floting/floting-img-2.html" alt="">
                        <h3 class="tp-floting-card-img-placeholder pt-10">Culture</h3>
                    </div>
                    <div class="tp-floting-card-img-item-3 d-none d-xl-block br-10 p-absolute">
                        <img src="assets/img/floting/floting-img-3.html" alt="">
                        <h3 class="tp-floting-card-img-placeholder pt-10">Moment</h3>
                    </div>
                    <div class="tp-floting-card-img-item-4 br-10 p-absolute">
                        <img src="assets/img/floting/floting-img-4.html" alt="">
                        <h3 class="tp-floting-card-img-placeholder pt-10">Herritage</h3>
                    </div>
                    <div class="tp-floting-card-img-item-5 br-10 d-none d-lg-block p-absolute">
                        <img src="assets/img/floting/floting-img-5.html" alt="">
                        <h3 class="tp-floting-card-img-placeholder pt-10">Passionate</h3>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Mirrored from html.aqlova.com/landor-prev/landor/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Jun 2026 07:22:13 GMT -->
</html>